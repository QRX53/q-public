...
sudo pacman -S jre-openjdk-headless jre-openjdk jdk-openjdk openjdk-doc openjdk-src figlet maven git
# clone the repo into a new folder
git clone http://github.com/qRX53/Q-public/ QLANGUPDATEFOLDERTEMP 2>/dev/null
